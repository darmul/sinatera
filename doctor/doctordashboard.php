                ...
                <div class="container-fluid">
                    ...
                    <div class="panel panel-primary filterable">
                       ...
                       <div class="panel-heading">
                        <h3 class="panel-title">Daftar Pemeriksaan</h3>
                        ...
                        <table class="table table-hover table-bordered">
                            <thead>
                                <tr class="filters">
                                    ...
                                    <th><input type="text" class="form-control" placeholder="Hari" disabled></th>
                                    ...
                                    <th><input type="text" class="form-control" placeholder="Spesialisasi" disabled></th>
