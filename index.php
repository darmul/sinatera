...
?>
<script type="text/javascript">
alert('Akun berhasil dibuat. Mohon Masuk untuk membuat mendaftar.');
</script>
<?php
}
else
...
?>
<script type="text/javascript">
alert('Pengguna telah terdaftar. Mohon coba lagi');
</script>
<?php
}
...
<html lang="en">
    ...
    <body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="#" data-toggle="modal" data-target="#myModal">Buat Akun</a></li>
                   
                        <li>
                            <p class="navbar-text">Sudah memiliki akun?</p>
                        </li>
                        <li class="dropdown">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <form class="form" role="form" method="POST" accept-charset="UTF-8" >
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="icPatient" placeholder="No. KTP" required>
                                                </div>
                                                <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <form action="<?php $_PHP_SELF ?>" method="POST" accept-charset="utf-8" class="form" role="form">
                                        <h4>Tidak dipungut biaya</h4>
                                        <div class="row">
                                            <div class="col-xs-6 col-md-6">
                                                <input type="text" name="patientFirstName" value="" class="form-control input-lg" placeholder="Nama Depan" required />
                                            </div>
                                            <div class="col-xs-6 col-md-6">
                                                <input type="text" name="patientLastName" value="" class="form-control input-lg" placeholder="Nama Belakang" required />
                                            </div>
                                        </div>
                                        
                                        <input type="text" name="patientEmail" value="" class="form-control input-lg" placeholder="Email"  required/>
                                        <input type="number" name="icPatient" value="" class="form-control input-lg" placeholder="No. KTP"  required/>
                                        
                                        
                                        <input type="password" name="password" value="" class="form-control input-lg" placeholder="Kata Sandi"  required/>
                                        
                                        <input type="password" name="confirm_password" value="" class="form-control input-lg" placeholder="Konfirmasi Kata Sandi"  required/>
                                        ...
                                        <label class="radio-inline">
                                            <input type="radio" name="patientGender" value="pria" required/>Pria
                                        </label>
                                        <label class="radio-inline" >
                                            <input type="radio" name="patientGender" value="wanita" required/>Wanita
                                        </label>
                                        <br />
                                        <span class="help-block"> Dengan menggunakan website RS Sinatera, Anda setuju dengan syarat dan ketentuan yang berlaku. </span>
                                        
                                        <button class="btn btn-lg btn-primary btn-block signup-btn" type="submit" name="signup" id="signup">Buat Akun</button>
                                    </form>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-5">
                        ...
                        <p>Mohon <span class="label label-danger">masuk</span> untuk mendaftar </p>
        ...
        <div class="copyright-bar bg-black">
            <div class="container">
                <p class="pull-left small">© M. Haekal</p>
