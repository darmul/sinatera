	...
	<nav class="navbar navbar-default " role="navigation">
			<div class="container-fluid">
				...
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="patient.php"><img alt="Brand" src="assets/img/logo.png" height=33px"></a>
				</div>
						...
						<div class="col-md-3 col-sm-3">
							...
							<div class="user-wrapper">
								<div class="description">
									...
									<hr />
									<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal">Ubah Data</button>
								</div>
							</div>
						</div>
