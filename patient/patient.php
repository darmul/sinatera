						...
						echo "<div class='row'>";
							echo "<div class='col-lg-12'>";
								echo "<div class='alert alert-danger alert-dismissable'>";
									...
									echo " <i class='fa fa-info-circle'></i>  <strong>Mohon lengkapi profil Anda</strong>" ;
								echo "  </div>";
							echo "</div>";
							// <!-- notification end -->
							...
							?>
							<!-- notification end -->
							<h2>Hai <?php echo $userRow['patientFirstName']; ?> <?php echo $userRow['patientLastName']; ?>. Daftar sekarang !</h2>
